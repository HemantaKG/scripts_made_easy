...
Run the script as follow:
	$> python generatenagioscfg.py --ifn <<input csv filename>> --floc <<input file location>> --gn <<Nagios host group name>> --ofn <<output cfg filename>>
	Example:
	$> python generatenagioscfg.py --ifn ipphone.txt --floc /home/hemanta/Desktop/ --gn ipphone --ofn ipphone
